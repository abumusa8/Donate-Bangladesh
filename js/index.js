...
//    const inputbtn = parseFloat(document.getElementById('input-btn').value)
   ...
   const loss =mainblance-inputbtn
    ...
    historyItem.className='bg-red border shadow max-lg:h-36 max-lg:mx-[10px] max-sm:h-40 h-20 max-sm:mx-[20px]  mx-[200px] mt-2 p-3 rounded-xl'
...
//    const inputbtn = parseFloat(document.getElementById('input-btn2').value)
   ...
   const loss =mainblance-inputbtn
    ...
    historyItem.className='bg-red border max-lg:h-36 max-lg:mx-[10px] shadow max-sm:h-40 h-20 max-sm:mx-[20px] mx-[200px] mt-2 p-3 rounded-xl'
        historyItem.innerHTML = `
            <p class="font-bold">${inputbtn} ${donate}</p>
            <p class="text-gray-500">${new Date().toString()} ${new Date().toTimeString()}</p>
        `
